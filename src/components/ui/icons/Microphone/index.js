...
var Microphone = function (_a) {
    var _b = _a.muted, muted = _b === void 0 ? false : _b, _c = _a.poorConnection, poorConnection = _c === void 0 ? false : _c, rest = __rest(_a, ["muted", "poorConnection"]);
    var iconPath = getPath(muted, poorConnection);
    return (React.createElement(StyledSvg, __assign({}, rest, { muted: muted, poorConnection: poorConnection, title: muted ? 'Muted microphone' : 'Microphone', "data-testid": poorConnection ? 'poor-connection-mic' : 'good-connection-mic' }),
