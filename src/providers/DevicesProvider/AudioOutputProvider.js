...
var AudioOutputContext = createContext(null);
var AudioOutputProvider = function (_a) {
    var children = _a.children;
    var audioVideo = useAudioVideo();
    var _b = useState([]), audioOutputs = _b[0], setAudioOutputs = _b[1];
    var meetingManager = useMeetingManager();
    var _c = useState(meetingManager.selectedAudioOutputDevice), selectedAudioOutputDevice = _c[0], setSelectedAudioOutputDevice = _c[1];
    useEffect(function () {
    ...
    return (React.createElement(AudioOutputContext.Provider, { value: contextValue }, children));
};
var useAudioOutputs = function () {
    var context = useContext(AudioOutputContext);
    if (!context) {
