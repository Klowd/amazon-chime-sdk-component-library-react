...
Refer to the [primary introduction page](/?path=/docs/introduction--page) on how to get your app setup with a `MeetingProvider`, and for how to join a meeting.
...
_Note_ - You will need to have provided `meetingManager.getAttendee` with a function to fetch your attendee names, otherwise there will be no names in the roster. See the [MeetingManager documentation](/?path=/docs/providers-meetingmanager--page) for more information.
