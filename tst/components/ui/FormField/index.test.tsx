...
describe('FormField', () => {
  ...
  it('should render a basic Input FormField', () => {
    ...
    const component = <FormField label={label} field={Input} value='' onChange={mockFunction} />;
  ...
  it('should render a basic Input FormField with infoText', () => {
    ...
    const component = <FormField label={label} field={Input} value='' infoText={infoText} onChange={mockFunction} />;
  ...
  it('should render a basic Input FormField with error', () => {
    ...
    const component = <FormField label={label} field={Input} value='' error errorText={errorText} onChange={mockFunction} />;
    const { getByTestId } = renderWithTheme(lightTheme, component);
    const formField = getByTestId('form-field');
  ...
  it('should render a basic Input FormField with layout = input-only', () => {
    ...
    const component = <FormField label={label} field={Input} value='' layout={layout} onChange={mockFunction} />;
    const { queryByText } = renderWithTheme(lightTheme, component);
